...
QtObject {
  ...
  // Prefer a live theme link when present; otherwise use ~/.config/quickshell
  // so a pure Waybar migration does not need ~/.local/state/fuzi/current/theme.
  // Colors/shell.toml live next to shell.json — no theme directory required.
  readonly property string currentThemePath: home + "/.config/quickshell"

  property color foreground: "#ffffff"
  property color background: "#1a1b26"
  property color accent: "#36cbe7"
  ...
  readonly property QtObject bar: QtObject {
    ...
    property color text: root.flatColor(root.pick("bar.text", "foreground"), root.foreground)
    property color active: root.flatColor(root.pick("bar.active", "urgent"), root.urgent)
  }
  readonly property QtObject popups: QtObject {
    property color background: root.composed("popups.background", "popups.background-alpha", root.background, 1.0)
    property color text: root.flatColor(root.pick("popups.text", "foreground"), root.foreground)
  ...
  readonly property QtObject tooltip: QtObject {
    ...
    property color text: root.flatColor(root.pick("tooltip.text", "foreground"), root.foreground)
  ...
  readonly property QtObject notifications: QtObject {
    ...
    property color text: root.flatColor(root.pick("notifications.text", "foreground"), root.foreground)
    property color border: root.composed("notifications.border", "notifications.border-alpha", root.accent, 1.0)
    property color countdown: root.flatColor(root.pick("notifications.countdown", "accent"), root.accent)
  }
  readonly property QtObject menu: QtObject {
    property color background: root.composed("menu.background", "menu.background-alpha", root.background, 1.0)
    property color text: root.flatColor(root.pick("menu.text", "foreground"), root.foreground)
    ...
    property color selectedText: root.flatColor(root.pick("menu.selected-text", "accent"), root.accent)
  ...
  readonly property QtObject polkit: QtObject {
    ...
    property color text: root.flatColor(root.pick("polkit.text", "foreground"), root.foreground)
    property color textError: root.flatColor(root.pick("polkit.text-error", "urgent"), root.urgent)
    ...
    property color accent: root.flatColor(root.pick("polkit.accent", "accent"), root.accent)
  ...
  readonly property QtObject lock: QtObject {
    ...
    property color text: root.flatColor(root.pick("lock.text", "foreground"), root.foreground)
    ...
    property color textError: root.flatColor(root.pick("lock.text-error", "urgent"), root.urgent)
  ...
  readonly property QtObject imagePicker: QtObject {
    ...
    property color text: root.flatColor(root.pick("image-picker.text", "foreground"), root.foreground)
  ...
  // Style. User keys win, so a machine-level `~/.config/quickshell/shell.toml`
  ...
  // is where `fuzi display text size` writes `[font] base-size`. Watched so the
