  ...
  FloatingWindow {
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("fuzi.dev-gallery")
    }
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `fuzi font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["fuzi.clock", "fuzi.weather", "fuzi.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "fuzi.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "fuzi-menu", label: "Fuzi menu", description: "Launcher / system menu" },
