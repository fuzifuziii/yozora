...
Item {
  ...
  Process {
    id: laptopClosedProc
    command: ["bash", "-c", "fuzi-hw-laptop-closed && echo closed || echo open"]
  ...
  PolkitAgent {
    ...
    onIsRegisteredChanged: {
      if (isRegistered) console.log("fuzi polkit agent registered")
      else console.warn("fuzi polkit agent is not registered; another agent may be running")
    }
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "fuzi-polkit"
