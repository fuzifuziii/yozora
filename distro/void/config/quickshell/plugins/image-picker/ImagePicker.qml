...
Item {
  ...
  property string selectionFile: Quickshell.env("FUZI_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("FUZI_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("FUZI_IMAGE_SELECTOR_SELECTED")
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "fuzi-image-selector"
